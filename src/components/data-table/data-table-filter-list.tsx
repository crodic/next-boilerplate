          ...
          {index === 0 ? (
            ...
            <Select
              ...
              onValueChange={(value: string | null) => {
                if (value === "and" || value === "or") setJoinOperator(value);
              }}
            >
              <SelectTrigger
              ...
              <SelectContent
                ...
                className="w-24 min-w-(--radix-select-trigger-width) lowercase"
              >
      ...
      return (
        ...
        >
          <FacetedTrigger
            className={cn(
              buttonVariants({ variant: "outline", size: "sm" }),
              "w-full justify-between rounded font-normal lg:w-44"
            )}
          >
            <FacetedBadgeList
